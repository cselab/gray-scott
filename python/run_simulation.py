...
def parse_args():
    """
    Driver arguments.  These are passed on to the GrayScott class to setup the 
    problem.
    """
    ...
    parser.add_argument('--demo', action='store_true', help='Run a demo (https://www.chebfun.org/examples/pde/GrayScott.html)')
